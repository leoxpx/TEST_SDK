...
@interface GS_SWActionSheetVC : UIViewController

@property (nonatomic, retain) GS_SWActionSheet *actionSheet;

@end


@interface GS_SWActionSheet ()
{
    UIWindow *GS_SWActionSheetWindow;
}
...
@implementation GS_SWActionSheet
{
    UIView *view;
    UIView *_bgView;
}
...
- (void)destroyWindow
{
    if (GS_SWActionSheetWindow)
    {
        [self actionSheetContainer].actionSheet = nil;
        GS_SWActionSheetWindow.hidden = YES;
        if ([GS_SWActionSheetWindow isKeyWindow])
            [GS_SWActionSheetWindow resignFirstResponder];
        GS_SWActionSheetWindow.rootViewController = nil;
        GS_SWActionSheetWindow = nil;
    }
}
...
- (UIWindow *)window
{
    ...
    else
    {
        return GS_SWActionSheetWindow = ({
            ...
            window.rootViewController = [GS_SWActionSheetVC new];
            window;
        });
    }
}

- (GS_SWActionSheetVC *)actionSheetContainer
{
    return (GS_SWActionSheetVC *) [self window].rootViewController;
}
...
#pragma mark - GS_SWActionSheet Container

@implementation GS_SWActionSheetVC
...
- (void)setActionSheet:(GS_SWActionSheet *)actionSheet
{
